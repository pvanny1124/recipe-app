...
;Size is actually the number 2, not the address of where 2 is stored
(define size 2)
...
(define (a-plus-abs-b a b)
 ...
 ;for (a-plus-abs-b 2 3)
 ;(if (> 3 0) + -) 2 3)
 ; (+ 2 3)
 ; 5
;The result of the if conditional will return a primitive function to evaluate the resulting combination
...
;(if (= x 0) 0 y))
;0
;if 1, the interpreter gets trapped in a infinite loop trying to call the procedure (p) again and again.